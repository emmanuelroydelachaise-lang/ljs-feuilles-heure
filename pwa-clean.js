(() => {
  ...
  async function requestInstall() {
    ...
    alert('Chrome ne propose pas encore la fenêtre automatique. Dans Chrome, ouvre le menu ⋮ puis choisis « Installer l’application » ou « Ajouter à l’écran d’accueil ». Si cette option n’apparaît pas, recharge cette page une fois puis réessaie.');
  }

  document.addEventListener('DOMContentLoaded', async () => {
    setFreshAssetUrls();

    let btn = getInstallButton();
    if (btn) {
