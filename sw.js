...
const ASSETS = [
  ...
  './admin-reset.js', './ui-labels.js', './admin-projects.js', './interim-agency.js', './admin-archives.js', './pwa-clean.js', './print-logo-fix.js', './print-ready-fix.js',
